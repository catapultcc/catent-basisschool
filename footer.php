        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-sm-6 text-left text-md-right">
                    <p class="m-0">Tekst en fotografie: <a href="https://theo-smits.nl/" style="color: #000" target="_blank" onclick="gtag('event', 'Klik', { event_category:  'Footer', event_action: 'Theo Smits'});"><u>Theo Smits</u></a> | Ontwerp en realisatie: <a href="https://www.catapult.nl" style="color: #000;" onclick="gtag('event', 'Klik', { event_category:  'Footer', event_action: 'Catapult'});"><u>Catapult creëert</u></a></p>
