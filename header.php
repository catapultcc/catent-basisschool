...
<?php if(in_array('cc-dashboard/cc-dashboard.php', apply_filters('active_plugins', get_option('active_plugins')))){
	if (get_theme_mod("cookie_melding_v2")) { require_once ABSPATH . '/wp-content/plugins/cc-dashboard/koekje.php'; } } ?>
<!-- SCRIPTS INLADEN IVM AVG -->
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=<?php echo get_theme_mod("google_tagmanager_code");?>"
	...
	<div class="container">
		<div class="row">
			<a class="navbar-brand" href="<?php echo home_url(); ?>">
				<img class="headerlogo hoef" src="<?php echo get_theme_mod( 'eigen_logo' ); ?>" alt="<?php bloginfo('name'); ?>">
			</a>
			<div class="topinfo">
                <a href="tel:<?php echo get_field('telefoonnummer', 'option'); ?>" class="tekst-secondair d-none d-md-inline-block" onclick="gtag('event', 'Klik', { event_category:  'Header', event_action: 'Telefoonnummer'});">T. <?php echo get_field('telefoonnummer', 'option'); ?></a>
                <span class="social-icons-header">
					<?php if(get_field('social_media_facebook', 'option')) : ?>
					<a href="<?php echo get_field('social_media_facebook', 'option'); ?>" target="_blank" class="d-none d-md-inline-block"  onclick="gtag('event', 'Klik', { event_category:  'Header', event_action: 'Facebook'});">
						<span class="fa-stack fa-2x tekst-secondair" style="margin-top:-8px">
							<i class="fa fa-circle fa-stack-2x"></i>
							<i class="fab fa-facebook-f fa-stack-1x fa-inverse"></i>
						</span>
					</a>
					<?php endif; ?>
					<a href="tel:<?php echo get_field('telefoonnummer', 'option'); ?>" target="_blank" class="d-inline-block d-md-none" onclick="gtag('event', 'Klik', { event_category:  'Header', event_action: 'Telefoon'});">
						<span class="fa-stack fa-2x tekst-secondair" style="margin-top:-8px">
							<i class="fa fa-circle fa-stack-2x"></i>
							<i class="fas fa-phone fa-stack-1x fa-inverse"></i>
						</span>
					</a>
					<button data-toggle="modal" data-target="#searchModal"  onclick="gtag('event', 'Klik', { event_category:  'Header', event_action: 'Zoekfunctie'});">
						<span class="fa-stack fa-2x tekst-secondair" style="margin-top:-8px">
							<i class="fa fa-circle fa-stack-2x"></i>
            ...
            <?php /*?><div class="d-md-none text-right zoek-header social-icons-header">
				...
				<a href="tel:<?php echo get_field('telefoonnummer', 'option'); ?>" target="_blank">
					<span class="fa-stack fa-2x tekst-secondair" style="margin-top:-8px">
						<i class="fa fa-circle fa-stack-2x"></i>
						<i class="fas fa-phone fa-stack-1x fa-inverse"></i>
					</span>
