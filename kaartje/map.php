...
?>
        ...
        var contentString<?php echo $teller;?> = '<a href="<?php the_permalink();?>"><div class="popup-box">'+
            '<div class="popup-foto"><img src="<?php echo $popup_beeld['url']; ?>" width="200"></div>'+
            '<div class="popup-kop vlak-groen tekst-wit"><?php echo addslashes(get_field('locatie_naam')); ?></div>'+
            '</div></a>';
